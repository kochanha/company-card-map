...
export default function FilterBar({
  ...
  return (
    <div className="fixed top-[3.5rem] left-0 right-0 z-40 bg-white/90 backdrop-blur-sm border-b border-gray-100">
      <div className="max-w-screen-xl mx-auto flex gap-1.5 px-4 py-2.5 overflow-x-auto scrollbar-hide items-center">
        <button
